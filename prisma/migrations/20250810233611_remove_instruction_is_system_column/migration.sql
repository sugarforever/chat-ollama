/*
  ...
  - You are about to drop the column `is_system` on the `Instruction` table. All the data in the column will be lost.
...
INSERT INTO "new_Instruction" ("id", "instruction", "is_public", "name", "user_id") SELECT "id", "instruction", "is_public", "name", "user_id" FROM "Instruction";
