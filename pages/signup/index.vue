...
const schema = object({
  ...
  email: string().email(t('auth.emailRule1')).required(t('global.required')),
  password: string().min(6, 'Password must be at least 6 characters').required(t('global.required')),
  confirmPassword: string().required(t('global.required')).test('passwords-match', 'Passwords must match', function (value) {
  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">Sign up to start your first chat</p>
      </div>
